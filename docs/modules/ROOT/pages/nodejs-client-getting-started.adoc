...
[source]
----
mkdir hazelcast-nodejs-client
cd hazelcast-nodejs-client
----
...
In this tutorial, you learned how to get started with Hazelcast Node.js Client and put data into a distributed map.
